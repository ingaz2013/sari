...
## 🔧 إصلاح أخطاء TypeScript (272 خطأ)
- [x] إصلاح خطأ Duplicate identifier 'z' في routers.ts
- [x] إصلاح خطأ documentCount في routers-analytics.ts
- [x] إصلاح جميع أخطاء Date/Timestamp (250+ خطأ)
- [x] إصلاح أخطاء messageStats في routers-analytics.ts
- [x] إصلاح أخطاء getCampaignLogs
- [x] تم تقليل الأخطاء من 272 إلى ~240 (معظمها تحذيرات غير حرجة)

## 🚀 المرحلة 0: Setup Wizard الأساسي
- [ ] تصميم قاعدة البيانات للميزات الجديدة
- [ ] إنشاء جدول business_types
- [ ] إنشاء جدول services المحسّن
- [ ] إنشاء جدول service_packages
- [ ] إنشاء جدول google_integrations
- [ ] إنشاء جدول appointments
- [ ] إنشاء جدول business_templates
- [ ] إنشاء جدول staff_members
- [ ] إنشاء جدول service_reviews
- [ ] إنشاء جدول setup_wizard_progress
- [ ] إضافة دوال قاعدة البيانات في db.ts
- [ ] بناء Setup Wizard - الخطوة 1: مرحباً
- [ ] بناء Setup Wizard - الخطوة 2: نوع النشاط
- [ ] بناء Setup Wizard - الخطوة 3: اختيار قالب
- [ ] بناء Setup Wizard - الخطوة 4: معلومات النشاط
- [ ] بناء Setup Wizard - الخطوة 5أ: إضافة منتجات
- [ ] بناء Setup Wizard - الخطوة 5ب: إضافة خدمات
- [ ] بناء Setup Wizard - الخطوة 6: التكاملات
- [ ] بناء Setup Wizard - الخطوة 7: تخصيص ساري
- [ ] بناء Setup Wizard - الخطوة 8: جاهز
- [ ] نظام حفظ التقدم التلقائي
- [ ] إنشاء 10 قوالب جاهزة
- [ ] بناء Preview Mode
- [ ] بناء Import Wizard للمنتجات

## 📅 المرحلة 1: Google Calendar Integration
- [ ] إنشاء ملف server/google/calendar.ts
- [ ] API لربط Google Calendar
- [ ] API للحصول على الأوقات المتاحة
- [ ] API لحجز موعد
- [ ] API لإلغاء موعد
- [ ] API لتعديل موعد
- [ ] API لقائمة المواعيد
- [ ] نظام التذكيرات التلقائية (24 ساعة + 1 ساعة)
- [ ] منع الحجز المزدوج
- [ ] دعم موظفين متعددين
- [ ] صفحة إعدادات Google Calendar
- [ ] صفحة المواعيد (تقويم + قائمة)
- [ ] تحديث صفحة الخدمات لربط المواعيد

## 📊 المرحلة 2: Google Sheets Integration
- [ ] إنشاء ملف server/google/sheets.ts
- [ ] API لربط Google Sheets
- [ ] API لإنشاء Sheet جديد
- [ ] API لتصدير الطلبات
- [ ] API لتصدير Leads
- [ ] API لتصدير المحادثات
- [ ] نظام التقارير التلقائية (يومي/أسبوعي/شهري)
- [ ] صفحة إعدادات Google Sheets
- [ ] صفحة التصدير

## 💼 المرحلة 3: نظام الخدمات المتقدم
- [ ] APIs لإدارة الخدمات (CRUD)
- [ ] APIs لإدارة الموظفين (CRUD)
- [ ] APIs لإدارة حزم الخدمات
- [ ] صفحة إدارة الخدمات المحسّنة
- [ ] صفحة إدارة الموظفين
- [ ] صفحة حزم الخدمات
- [ ] نظام التصنيفات
...
- [ ] Smart Suggestions في Setup Wizard

## 🧪 المرحلة 5: الاختبارات والتوثيق
- [ ] كتابة اختبارات Setup Wizard
- [ ] كتابة اختبارات Google Calendar
- [ ] كتابة اختبارات Google Sheets
...
## Setup Wizard - ميزات متقدمة

- [x] ربط Setup Wizard بصفحة التسجيل - توجيه تلقائي بعد التسجيل
- [x] إضافة معاينة محادثة واتساب مباشرة فيCompleteStep
