...
- [ ] إنشاء ملف server/automation/greetings.ts
- [ ] إضافة جدول customer_occasions (مناسبات العملاء)
- [ ] دالة detectOccasion (اكتشاف المناسبات من المحادثات)
- [ ] دالة sendGreeting (إرسال تهنئة)
- [ ] دالة sendSpecialOffer (إرسال عرض خاص)
- [ ] إضافة Cron Job للتحقق اليومي
- [ ] إضافة APIs في routers.ts
- [ ] إنشاء صفحة /merchant/greetings لإدارة المناسبات
- [ ] كتابة الاختبارات
- [ ] اختبار النظام الكامل
...
- [ ] إضافة APIs في routers.ts
- [ ] إنشاء صفحة /merchant/discount-codes لإدارة الكودات
- [ ] إنشاء صفحة /merchant/referrals لتتبع الإحالات
- [ ] كتابة الاختبارات
- [ ] اختبار النظام الكامل

### الميزة 7: طلب التقييمات بعد الشراء
- [ ] إنشاء ملف server/automation/review-request.ts
- [ ] دالة shouldRequestReview (تحديد متى نطلب التقييم)
- [ ] دالة sendReviewRequest (إرسال طلب تقييم)
- [ ] دالة saveReview (حفظ التقييم)
- [ ] دالة sendThankYouForReview (شكر العميل)
- [ ] إضافة Cron Job للتحقق اليومي
- [ ] إضافة APIs في routers.ts
- [ ] إنشاء صفحة /merchant/reviews لعرض التقييمات
- [ ] كتابة الاختبارات
