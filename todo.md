...
- [ ] دالة createAbandonedCartDiscount (إنشاء خصم خاص)
- [ ] إضافة Cron Job للتحقق كل 6 ساعات
- [ ] تحديث جدول conversations بحقل isAbandoned
- [ ] إضافة APIs في routers.ts
- [ ] كتابة الاختبارات
- [ ] اختبار النظام الكامل

### الميزة 4: نظام الفواتير بالواتساب
- [ ] تحديث server/invoices/generator.ts لدعم الواتساب
- [ ] دالة sendInvoiceViaWhatsApp (إرسال فاتورة PDF)
- [ ] ربط مع نظام الطلبات (إرسال تلقائي بعد الطلب)
